...
void GameCharacter::setPos(sf::Vector2f p){
    pos = p;
}
...
int GameCharacter::numObservers(){
...
void GameCharacter::findpath(sf::Vector2f d) {
    ...
    NodeState NStart(pos, size);
    NodeState NEnd(destination, {0, 0});
